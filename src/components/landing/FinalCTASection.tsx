      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Készen állsz, hogy{" "}
            <span className="text-gradient-gold">átlásd a játszmákat?</span>
          </h2>
          
          <p className="text-muted-foreground text-lg md:text-xl mb-4 max-w-2xl mx-auto">
            A manipuláció addig működik, amíg nem látod.
          </p>
          <p className="text-foreground text-lg md:text-xl mb-8 max-w-2xl mx-auto font-medium">
            Amint felismered — <span className="text-gold">vége a játéknak.</span>
          </p>
